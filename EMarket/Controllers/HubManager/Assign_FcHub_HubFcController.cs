...
namespace EMarket.Controllers.HubManager
{
    ...
    public class Assign_FcHub_HubFcController : ControllerBase
    {
        ...
        [Route("accept_all_data_from_pt_to_hub")]
        public Assign_FcHub_HubDTO accept_all_data_from_pt_to_hub([FromHeader(Name = "userid")] string userid, [FromBody] Assign_FcHub_HubDTO dto)
        {           
            dto.ipAddress = HttpContext.Connection.RemoteIpAddress.MapToIPv4().ToString();
            dto.user_id = Convert.ToInt32(userid);
           return _inter.accept_all_data_from_pt_to_hub(dto);
        }
